...
import type { SysButtonDto } from '@/service/main/system/sysButton/model';
import { getById, save, update } from '@/service/main/system/sysButton/api';
import { $t } from '@/locales';
import { actionCode } from '@/utils/common';
import type { FormInstance } from '@/typings/fs';
import { formItems, formRules } from '../data/form';

type FormDataType = SysButtonDto;
...
/** 初始化新增 */
async function initAdd(data: FormDataType) {
  formConfig.formData = {
    ...data,
    id: ''
  };
