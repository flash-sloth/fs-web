...
import type { SysButtonQuery, SysButtonVo } from '@/service/main/system/sysButton/model';
import { page, remove } from '@/service/main/system/sysButton/api';
...
watch(() => props.menuId, (menuId) => {
  if (menuId && gridOptions.pagerConfig) {
...
async function loadData(params: VxeGridPropTypes.ProxyAjaxQueryParams) {
  ...
  const param: Model.PageParam<SysButtonQuery> = queryBefore(params);
  param.model.menuId = props.menuId;
