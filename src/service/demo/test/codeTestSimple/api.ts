...
import type { CodeTestSimpleDto, CodeTestSimpleQuery, CodeTestSimpleVo } from './model';
 ...
 * @returns 每页数据
 */
export const page = (params: Model.PageParam<CodeTestSimpleQuery>) =>
  defHttp.request<Model.PageResult<CodeTestSimpleVo>>({
    url: `${MODULAR}/page`,
    method: RequestEnum.POST,
    params
  });
 ...
 * @returns 所有数据
 */
export const list = (params: CodeTestSimpleQuery) =>
  defHttp.request<CodeTestSimpleVo[]>({
    url: `${MODULAR}/list`,
    method: RequestEnum.POST,
    params
  });
 ...
 * @returns 是否成功
 */
export const save = (params: CodeTestSimpleDto) =>
 ...
 * @returns 是否成功
 */
export const update = (params: CodeTestSimpleDto) =>
  defHttp.request<number>({
    ...Api.Update,
    params
  });
